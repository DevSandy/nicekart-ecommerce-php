...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +918660225160</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> Accelstack@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-right">Designed by <span><a target="_blank" href="http://www.accelstack.in">Accelstack</a></span></p>
        </div>
      </div>
    </div>
